...
(defn setup []
  ...
  (let [xs        (range-incl 20 480 1)
        ...
        ys        (map sin rads)
        ys        (map #(pow % 3) ys)
        ys        (map (fn [y rad] (* 30 y (noise (* 2 rad)))) ys rads) ;; En vez de multiplicar por 30 aquí
                                                                        ;; Podría multiplicar por 30 en donde pone 1 en la línea de abajo
                                                                        ;; Sirve para amplificar la onda
